...
data_labeled = tokenizer.special_char(dataset_lab, "new_dataset_specialchar.txt")
data_unlabeled = tokenizer.special_char(dataset_unlab, "unlabeled_specialchar.txt", unlab = True)
